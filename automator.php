...
<html lang="en">
    ...
    <body>
                    ...
                    <div class="row">
                        <div class="col-lg-12" style="margin-top: 10rem;">
                            <div class="title-area-left center">
                                <span class="bg-title">Future Ready Automator</span>
                                <h1 class="title rts-text-anime-style-1">
                                    Future Ready Automator
                                </h1>
                                <hr style="border: 1px solid #000; width: 36rem; place-self: center;">
                                <p class="disc" style="color: #009688;">
                                    <b style="letter-spacing: 2px;">Precision-Powered, Future-Proof, Self-Optimizing Small Business Engine!!</b>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col">
                            <div class="faq-main-wrapper-content-inner-four">
                                ...
                                <div class="accordion mt--40" id="accordionExample">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#businessaut" class="btn-primary btn-white" style="border-radius: 4rem; padding: 14px; width: auto; background: #009688; color: #FFF; border: none;">
                                        Schedule your Autopilot Assessment now and start running your business smarter, faster, and more resilient than ever
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="businessaut" tabindex="-1" aria-labelledby="businessautLabel" aria-hidden="true" style="background: rgba(0, 0, 0, 0.5); align-content: center;">
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                ...
                function submitForm() {
                    ...
                    const message = `*Business Advisory - Future Ready Automator Support Request*\n\n` +
                        `*Contact Information*\n` +
