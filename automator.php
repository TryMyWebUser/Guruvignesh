                        ...
                        <div class="col">
                            <div class="faq-main-wrapper-content-inner-four">
                                ...
                                <div class="accordion mt--40" id="accordionExample">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#businessaut" class="btn-primary btn-white" style="border-radius: 4rem; padding: 14px; width: auto; background: #009688; color: #FFF !important; border: none;">
