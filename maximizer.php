                    ...
                    <div class="row">
                        <div class="col-lg-12" style="margin-top: 10rem;">
                            <div class="title-area-left center">
                                <span class="bg-title">Profit Maximizer</span>
                        ...
                        <div class="col">
                            <div class="faq-main-wrapper-content-inner-four">
                                ...
                                <div class="accordion mt--40" id="accordionExample">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#businessmax" class="btn-primary btn-white" style="border-radius: 4rem; padding: 14px; width: auto; background: #009688; color: #FFF; border: none;">
