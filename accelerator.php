...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col">
                            <div class="faq-main-wrapper-content-inner-four">
                                ...
                                <div class="accordion mt--40" id="accordionExample">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#businessacc" class="btn-primary btn-white" style="border-radius: 4rem; padding: 14px; width: auto; background: #009688; color: #FFF !important; border: none;">
                                        Book your strategy session today and activate future-proof growth engine
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal fade" id="businessacc" tabindex="-1" aria-labelledby="businessaccLabel" aria-hidden="true" style="background: rgba(0, 0, 0, 0.5); align-content: center;">
        ...
        <script>
            ...
            function submitForm() {
                ...
                const message = `*Business Advisory - Growth Accelerator Support Request*\n\n` +
                    `*Contact Information*\n` +
                    `Name: ${name}\n` +
                    `Firm: ${firmName}\n` +
                    `Email: ${email}\n` +
