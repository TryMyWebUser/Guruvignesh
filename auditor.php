...
<html lang="en">
    ...
    <body>
                        ...
                        <div class="col">
                            <div class="faq-main-wrapper-content-inner-four">
                                ...
                                <div class="accordion mt--40" id="accordionExample">
                                    ...
                                    <button type="button" data-bs-toggle="modal" data-bs-target="#businessaud" class="btn-primary btn-white" style="border-radius: 4rem; padding: 14px; width: auto; background: #009688; color: #FFF !important; border: none;">
        ...
        <div class="modal fade" id="businessaud" tabindex="-1" aria-labelledby="businessaudLabel" aria-hidden="true" style="background: rgba(0, 0, 0, 0.5); align-content: center;">
        ...
        <script>
            ...
            function submitForm() {
                ...
                const message = `*Business Advisory - Performance Auditor Support Request*\n\n` +
                    `*Contact Information*\n` +
                    `Name: ${name}\n` +
                    `Firm: ${firmName}\n` +
                    `Email: ${email}\n` +
